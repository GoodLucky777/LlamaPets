package net.lldv.llamapets.components.provider.data.connection;

import lombok.Getter;
import net.lldv.llamapets.components.provider.clients.simplesqlclient.MySqlClient;
import net.lldv.llamapets.components.provider.clients.simplesqlclient.objects.SqlColumn;
import net.lldv.llamapets.components.provider.clients.simplesqlclient.objects.SqlDocument;
import net.lldv.llamapets.components.provider.clients.simplesqlclient.objects.SqlDocumentSet;
...
import net.lldv.llamapets.components.provider.data.UDocumentSet;
import net.lldv.llamapets.components.provider.data.clientdetails.ClientDetails;
